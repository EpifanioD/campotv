var app = new Vue({
   ...
   mounted: function() {
    ...
    methods:{
        getAllNews() {
            axios.get('http://localhost/campotv/app/Action/News.php?action=index').then( response => {
        ...
        addNews() {
            ...
            axios.post('http://localhost/campotv/app/Action/News.php?action=create', formData).then( response => {
        ...
        updateNews() {
            ...
            axios.post('http://localhost/campotv/app/Action/News.php?action=update', formData).then( response => {
        ...
        deleteNews(){
            ...
            axios.post('http://localhost/campotv/app/Action/News.php?action=delete', formData).then( response => {
        ...
        exportXmlOrJson(action, withImage ) {
            var url = 'http://localhost/campotv/app/Action/News.php?action=' + action + '&image=' + withImage;
